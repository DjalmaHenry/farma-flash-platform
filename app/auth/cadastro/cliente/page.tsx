        ...
        <div className="max-w-3xl mx-auto">
          <Card className="shadow-lg">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl font-bold text-blue-800">Cadastro de Cliente</CardTitle>
              <CardDescription>Crie sua conta para comprar medicamentos com desconto</CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <Button className="w-full bg-lime-600 hover:bg-lime-700" asChild>
                <Link href="/usuario/dashboard">Criar Conta</Link>
              </Button>
              <div className="text-center text-sm">
                Já tem uma conta?{" "}
                <Link href="/auth/login/cliente" className="text-blue-800 hover:underline font-medium">
                  Faça login
                </Link>
              </div>
              <div className="text-center text-sm">
                <Link href="/auth/cadastro/farmacia" className="text-gray-500 hover:underline">
                  Sou uma farmácia
                </Link>
              </div>
            </CardFooter>
