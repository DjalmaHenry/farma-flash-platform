        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/auth/cadastro/cliente">
              <Button className="bg-lime-600 hover:bg-lime-700">Cadastrar</Button>
            </Link>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8 bg-gray-50">
        <Card className="w-full max-w-md shadow-lg">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-blue-800">Login de Cliente</CardTitle>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <Button className="w-full bg-blue-800 hover:bg-blue-900" asChild>
              <Link href="/usuario/dashboard">Entrar</Link>
            </Button>
            <div className="text-center text-sm">
              Não tem uma conta?{" "}
              <Link href="/auth/cadastro/cliente" className="text-blue-800 hover:underline font-medium">
                Cadastre-se
              </Link>
            </div>
            <div className="text-center text-sm">
              <Link href="/auth/login/farmacia" className="text-gray-500 hover:underline">
                Sou uma farmácia
              </Link>
            </div>
          </CardFooter>
